...
export function voiceFixture(over: Partial<VoiceSurfaceData> = {}): VoiceSurfaceData {
  ...
  return {
    ...
    audience: {
      ...
      platforms: [
        { value: 'tiktok', label: 'TikTok', videos: 528, active: false, href: voiceSurfaceHref(params, { platform: 'tiktok' }) },
        { value: 'reddit', label: 'Reddit', videos: 166, active: false, href: voiceSurfaceHref(params, { platform: 'reddit' }) },
      ],
      platform: null,
      kinds: [
      ...
      kindFilters: [
        { value: 'question', label: 'Asking how it works', videos: 472, active: false, href: voiceSurfaceHref(params, { kind: 'question' }) },
        { value: 'praise', label: 'Saying it worked', videos: 389, active: false, href: voiceSurfaceHref(params, { kind: 'praise' }) },
      ],
      kind: null,
      kindsNote: null,
      ...
      personas: [
        {
          ...
          videos: 527, denominator: 1388, pct: 38,
...
export const fixtureHeardLine = (d: VoiceSurfaceData): string =>
  heardLine({ firstHeard: d.theme.firstHeard, monthsSeen: d.theme.monthsSeen, monthsDrawn: d.theme.monthsDrawn })
