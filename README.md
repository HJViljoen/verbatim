...
| `backfill-keyword-candidates.ts` | Recompute `keyword_candidates` for one run or every completed run of a client (repairs a swallowed `keyword-discovery` step). Dry-run prints the top 30; `--apply` writes |
