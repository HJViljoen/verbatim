...
const READINESS: ReadinessLike[] = [
  { id: 'subject-set', input: 'the five to eight subjects this workspace is read against', status: 'missing', owner: 'Client', unlocks: 'Name the subjects in Settings › Subjects.' },
  { id: 'rival-accounts', input: 'the rival accounts we read', status: 'partial', owner: 'Client', unlocks: 'Add each rival\'s own accounts.' },
  { id: 'months-of-history', input: 'months carrying 100 videos', status: 'exists', owner: 'Verbatim ops', unlocks: 'Nothing — it is there.' },
  { id: 'decisions', input: 'what was decided about each one', status: 'exists', owner: 'Client', unlocks: 'Mark each recommendation.' },
]
