 ...
 *
 *  NULL for every theme while `directionWordsFor('documents.trajectory')` is off (D1). This
...
export function trajectoryWord(t: Trajectory | null | undefined, directionWords = directionWordsFor('documents.trajectory')): string | null {
